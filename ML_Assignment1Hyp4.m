%Second Hypothesis By Using All Bedrooms Bathrooms and sqft Living and sqft
%lot
...
UTrain = T{1:18000,[3 4 5 6 7 9 10 11 12 13 14 15 16  18]};
UTest = T{18001:end,[3 4 5 6 7 9 10 11 12 13 14 15 16  18]};
m=length(UTrain);
mTest=length(UTest);

%X=[ones(m,1) U U1 U.^2 U.^3];     
X=[ones(m,1) (UTrain(:,1:2)) (UTrain(:,3:end).^2)];
XTest=[ones(mTest,1) (UTest(:,1:2)) (UTest(:,3:end).^2) ];
