%Second Hypothesis By Using All the sqft Variables normalized and till the
%power of 3
...
UTrain = T{1:18000,[6 7 13 14]};
UTest = T{18001:end,[6 7 13 14]};
m=length(UTrain);
mTest=length(UTest);

%X=[ones(m,1) U U1 U.^2 U.^3];     
X=[ones(m,1) UTrain (UTrain.^2) (UTrain.^3)];
